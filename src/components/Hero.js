...
export default function Hero() {
  ...
  return (
    <section className="relative w-full bg-[#fbfbfb] overflow-hidden min-h-[40rem] sm:min-h-[44rem] md:min-h-[48rem] lg:min-h-[55rem] xl:min-h-[58rem] flex items-stretch pt-[4.5rem]">
      ...
      <div className="absolute right-0 top-[6rem] w-[34%] xl:w-[32%] z-20 hidden lg:block lg:pr-5">
      ...
      <div className="container-custom relative z-10 w-full flex flex-col justify-between py-12 lg:py-16">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-8 items-start w-full relative h-full flex-1">
          ...
          <div className="absolute left-0 bottom-0 w-[38%] h-[92%] z-20 pointer-events-none">
          ...
          <div className="absolute top-4 left-[22%] xl:left-[24%] z-30 select-none pointer-events-none">
            <Reveal duration={1.2} delay={0.15} y={40}>
              <h1 className="font-display font-bold text-[7rem] xl:text-[9.5rem] leading-[0.82] text-[#0c0c0e] tracking-tighter">
                ARCHI—<br />TECTURE
              </h1>
            </Reveal>
          </div>
          ...
          <div className="col-start-6 col-span-4 pt-[20rem] xl:pt-[24rem] flex flex-col gap-6 relative z-30">
            <Reveal duration={0.8} delay={0.3} y={20}>
              <div className="font-display font-semibold text-[1.125rem] text-black-2 tracking-[0.15em] uppercase">
                SINCE 2008
              </div>
            </Reveal>
            ...
            <Reveal duration={0.8} delay={0.5} y={30}>
              <div className="bg-black-3 text-white p-8 xl:p-10 rounded-lg relative overflow-hidden flex flex-col gap-6 shadow-xl border border-white/5">
          ...
          <div className="absolute bottom-8 right-0 flex flex-col items-center gap-6 z-20">
            ...
            <div className="flex flex-col gap-5 text-[#1a1a1a]">
              <a href="#" className="hover:text-primary transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
              ...
              <a href="#" className="hover:text-primary transition-all duration-300 hover:scale-110" aria-label="Instagram">
                <svg className="w-[1.25rem] h-[1.25rem]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="hover:text-primary transition-all duration-300 hover:scale-110" aria-label="Twitter">
                <svg className="w-[1.25rem] h-[1.25rem]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="lg:hidden flex flex-col gap-6 sm:gap-8 w-full relative z-10 px-1">
          ...
          <div>
            ...
            <div className="font-display font-semibold text-[0.875rem] sm:text-[1rem] text-primary tracking-widest uppercase mt-3 sm:mt-4">
              SINCE 2008
            </div>
          </div>

...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-[28.125rem] bg-black-2 text-white z-50 shadow-2xl transition-transform duration-300 ease-in-out transform flex flex-col ${
